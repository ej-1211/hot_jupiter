...
target_hj = 'Earth'
zonal_wave_number = 1 #k : 0 means the "first" zonal mode but the index is 0 ; 41 in total (0~40)
vertical_wave_numebr = 5 #n : 1 means the first vertical mode ; 0 means nothing ; 20 in total 
meridional_wave_number = 1 #m : 1 means the first meridional mode ; 0 means nothing ; 30 in total
meridional_mode_type = 'EIG' # 'EIG' or 'WIG' or 'ROT'

# for eigenfrequency:
FIND_EIGENFREQUNCY = False
print_whole_freq_for_all_vertical_modes = False
# =======================
# 1. Read in the data
...
if print_whole_freq_for_all_vertical_modes and FIND_EIGENFREQUNCY:
    ...
    print('--------------------------------------------------')
elif print_whole_freq_for_all_vertical_modes == False and FIND_EIGENFREQUNCY:
...
print(v[-1])
print(wn_data)
plt.plot(u, lat, label='u from Hough')
plt.plot(v, lat, label='v from Hough')

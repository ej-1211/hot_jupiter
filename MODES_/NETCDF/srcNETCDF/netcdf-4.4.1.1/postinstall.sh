...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lm " CFLAGS="-I/asiaa/home/yichiehchang/MODES/NETCDF/NETCDF_INST/include" LDFLAGS="-L/asiaa/home/yichiehchang/MODES/NETCDF/NETCDF_INST/lib" ./configure --prefix=/asiaa/home/yichiehchang/MODES/NETCDF/NETCDF_INST $STATIC_BUILD $SHARED_BUILD
        LIBS="-lm " make
        LIBS="-lm " make check
    fi

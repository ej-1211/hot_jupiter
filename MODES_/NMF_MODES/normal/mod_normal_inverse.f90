...
!   Rossby wave -> in the config file, filtered all the nerifional modes and
!   keep rot_n_s = 3, rot_n_e = 30. Also, make the kmode_s = 2 and k_mode_e=20
!    w0(2*maxl,:,:) = (0.0d0,0.0d0) 
!    w0(:,:,0) = (0.0d0,0.0d0)
